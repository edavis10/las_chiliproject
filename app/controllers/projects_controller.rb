...
class ProjectsController < ApplicationController
  ...
  before_filter :find_project, :except => [ :index, :list, :new, :create, :copy, :autocomplete_for_project]
  before_filter :authorize, :except => [ :index, :list, :new, :create, :copy, :archive, :unarchive, :destroy, :autocomplete_for_project]
